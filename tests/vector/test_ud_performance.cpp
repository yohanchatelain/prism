...
TEST(UDArrayBenchmark, SRAddF32) {
  ...
  fprintf(stderr, "Measure function ud::addf32 with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 8
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::subf32x2_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 8
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::mulf32x2_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 8
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::divf32x2_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 8
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::sqrtf32x2_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 8
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::fmaf32x2_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::addf64x2_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::subf64x2_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::mulf64x2_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::divf64x2_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::sqrtf64x2_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::fmaf64x2_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::addf32x4_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::subf32x4_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::mulf32x4_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::divf32x4_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::sqrtf32x4_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 16
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::fmaf32x4_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::addf32x8_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::subf32x8_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::mulf32x8_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::divf32x8_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::sqrtf32x8_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::fmaf32x8_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::addf64x4_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::subf64x4_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::mulf64x4_v with %zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::divf64x4_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::sqrtf64x4_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 32
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::fmaf64x4_v with %%zu repetitions\n", N);
...
#if HWY_MAX_BYTES >= 64
  constexpr size_t N = repetitions;
  fprintf(stderr, "Measure function ud::addf64x8_v with %%zu repetitions\n", N);
