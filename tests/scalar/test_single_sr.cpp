...
template <typename T> void test_op(helper::Args<T> args, const Op op) {
  ...
  switch (op.type()) {
  case Op::Type::Add:
    print(sr::add(args[0], args[1]));
    break;
  case Op::Type::Sub:
    print(sr::sub(args[0], args[1]));
    break;
  case Op::Type::Mul:
    print(sr::mul(args[0], args[1]));
    break;
  case Op::Type::Div:
    print(sr::div(args[0], args[1]));
    break;
  case Op::Type::Sqrt:
    print(sr::sqrt(args[0]));
    break;
  case Op::Type::Fma:
    print(sr::fma(args[0], args[1], args[2]));
    break;
  default:
