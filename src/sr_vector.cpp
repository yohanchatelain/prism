...
#define HWY_TARGET_INCLUDE "src/sr_vector.cpp" // this file
...
template <typename T>
HWY_INLINE void _round(const T *HWY_RESTRICT sigma, const T *HWY_RESTRICT tau,
...
template <typename T>
HWY_INLINE void _add(const T *HWY_RESTRICT a, const T *HWY_RESTRICT b,
                     T *HWY_RESTRICT result, const size_t count) {
...
template <typename T>
HWY_INLINE void _sub(const T *HWY_RESTRICT a, const T *HWY_RESTRICT b,
                     T *HWY_RESTRICT result, const size_t count) {
  using D = hn::ScalableTag<T>;
  const D d;
  const auto N = hn::Lanes(d);
...
template <typename T>
HWY_INLINE void _mul(const T *HWY_RESTRICT a, const T *HWY_RESTRICT b,
                     T *HWY_RESTRICT result, const size_t count) {
  using D = hn::ScalableTag<T>;
  const D d;
  const auto N = hn::Lanes(d);
...
template <typename T>
HWY_INLINE void _div(const T *HWY_RESTRICT a, const T *HWY_RESTRICT b,
                     T *HWY_RESTRICT result, const size_t count) {
  using D = hn::ScalableTag<T>;
  const D d;
  const auto N = hn::Lanes(d);
...
template <typename T>
HWY_INLINE void _sqrt(const T *HWY_RESTRICT a, T *HWY_RESTRICT result,
                      const size_t count) {
  using D = hn::ScalableTag<T>;
  const D d;
  const auto N = hn::Lanes(d);
...
template <typename T>
HWY_INLINE void _fma(const T *HWY_RESTRICT a, const T *HWY_RESTRICT b,
                     const T *HWY_RESTRICT c, T *HWY_RESTRICT result,
                     const size_t count) {
  using D = hn::ScalableTag<T>;
  const D d;
